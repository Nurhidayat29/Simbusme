			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<a href="<?=site_url('penduduk/form')?>" class="btn btn-social btn-flat btn-success btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Tambah Data"><i class="fa fa-plus"></i> Anggota Domisili</a>
										...
										<div class="row">
											<div class="col-sm-9">
												...
												<select class="form-control input-sm " name="dusun" onchange="formAction('mainform','<?= site_url('penduduk/dusun')?>')">
													<option value="">Pilih <?= ucwords($this->setting->sebutan_kecamatan)?></option>
												...
												<?php if ($dusun): ?>
													<select class="form-control input-sm" name="rw" onchange="formAction('mainform','<?= site_url('penduduk/rw')?>')" >
														<option value="">Sub Ranting</option>
												...
												<div class="table-responsive">
													...
													<table class="table table-bordered table-striped dataTable table-hover nowrap">
														...
														<tr>
															...
															<th >Foto</th>
															<?php if ($o==2): ?>
																<th><a href="<?= site_url("penduduk/index/$p/1")?>">KTA <i class='fa fa-sort-asc fa-sm'></i></a></th>
															<?php elseif ($o==1): ?>
																<th><a href="<?= site_url("penduduk/index/$p/2")?>">KTA <i class='fa fa-sort-desc fa-sm'></i></a></th>
															<?php else: ?>
																<th><a href="<?= site_url("penduduk/index/$p/1")?>">KTA <i class='fa fa-sort fa-sm'></i></a></th>
															<?php endif; ?>
															<th>Tag ID Card</th>
															<?php if ($o==4): ?>
															...
															<th>Alamat</th>
															<th><?= ucwords($this->setting->sebutan_kecamatan)?></th>
															<th>Sub Ranting</th>										
