			...
			<div id="content-main" class="grid_7">
				...
				<table width="100%" style="border: solid 0px black; text-align: center;">
					...
					<tr>
						...
						<td>
							<h3>BIODATA ANGGOTA BS. MELATI</h3>
							<h5><?= ucwords($this->setting->sebutan_kabupaten)?> <?= $desa['nama_kabupaten']?>, <?= ucwords($this->setting->sebutan_kecamatan)?> <?= $desa['nama_kecamatan']?>, <?= ucwords($this->setting->sebutan_desa)?> <?= $desa['nama_desa']?></h5>
						</td>
					</tr>
				</table>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td align="center" scope="col" width="50%"><?= ucwords($this->setting->sebutan_kabupaten)?> <?= $desa['nama_kabupaten']?>, <?= tgl_indo(date("Y m d"))?></td>
					</tr>
					<tr>
						<td align="center">&nbsp;</td>
						<td align="center">&nbsp;</td>
						<td align="center">Ketua <?= ucwords($this->setting->sebutan_kabupaten)?> <?= $desa['nama_kabupaten']?></td>
					</tr>
					<tr>
					...
					<tr>
						<td align="center" height="100"><b>( <?= strtoupper($penduduk['nama'])?> )<b></td>
						<td align="center">&nbsp;</td>
