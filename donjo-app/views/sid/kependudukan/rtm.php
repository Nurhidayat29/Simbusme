	...
	<section class="content" id="maincontent">
		<div class="row">
			<div class="col-md-12">
  	          ...
  	          <i class="fa fa-plus"></i>Tambah Pengurus <?= ucwords($this->setting->sebutan_kabupaten)?>
            </a>
														...
														<tbody>
															<?php foreach ($main as $data): ?>
																<tr>
																	...
																	<td><?=$data['no']?></td>
																	<td nowrap>
                                    <a href="<?=site_url("rtm/urut/$data[pamong_id]/1")?>" class="btn bg-olive btn-flat btn-sm"  title="Pindah Posisi Ke Bawah"><i class="fa fa-arrow-down"></i></a>
                                    <a href="<?=site_url("rtm/urut/$data[pamong_id]/2")?>" class="btn bg-olive btn-flat btn-sm"  title="Pindah Posisi Ke Atas"><i class="fa fa-arrow-up"></i></a>
																		<?php if ($data['pamong_id']!="707"): ?>
																			<a href="<?= site_url("rtm/form/$data[pamong_id]")?>" class="btn bg-orange btn-flat btn-sm"  title="Ubah Data"><i class="fa fa-edit"></i></a>
																			<?php if ($data['pamong_ttd'] == '1'): ?>
																				<a href="<?= site_url('rtm/ttd_off/'.$data['pamong_id'])?>" class="btn bg-navy btn-flat btn-sm" title="Bukan TTD default"><i class="fa fa-pencil"></i></a>
																			<?php else: ?>
																				<a href="<?= site_url('rtm/ttd_on/'.$data['pamong_id'])?>" class="btn bg-purple btn-flat btn-sm" title="Jadikan TTD default"><i  class="fa fa-user"></i></a>
																			<?php endif ?>
																			<a href="#" data-href="<?= site_url("rtm/delete/$data[pamong_id]")?>" class="btn bg-maroon btn-flat btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i></a>
																		<?php endif ?>
																	</td>
