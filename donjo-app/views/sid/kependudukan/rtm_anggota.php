...
<div class="content-wrapper">
	<section class="content-header">
		<h1>Pengurus <?= ucwords($this->setting->sebutan_kabupaten )?></h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('hom_sid')?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?= site_url('pengurus')?>"</i> Daftar Pengurus</a></li>
			<li class="active">Pengurus <?= ucwords($this->setting->sebutan_kabupaten)?></li>
		</ol>
	</section>
			...
			<div class="col-sm-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<a href="<?= site_url()?>pengurus" class="btn btn-social btn-flat btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-arrow-circle-o-left"></i> Kembali Ke Daftar Pengurus</a>
					</div>
					<div class="box-body">
						<div class="form-group col-sm-12 form-horizontal">
							<label class="col-sm-4 col-lg-2 control-label kiri" for="status">DATA Pengurus</label>
							<div class="btn-group col-sm-8 kiri" data-toggle="buttons">
								<label for="pengurus_1" class="btn btn-info btn-flat btn-sm col-sm-3 form-check-label <?php if (empty($pamong) or !empty($individu)): ?>active<?php endif ?>">
									<input id="pengurus_1" type="radio"  name="pengurus" class="form-check-input" type="radio" value="1" <?php if (empty($pamong) or !empty($individu)): ?>checked<?php endif; ?> autocomplete="off" onchange="pengurus_asal(this.value);"> Dari Database Anggota
								</label>
						...
						<form action="" id="main" name="main" method="POST"  class="form-horizontal">
							<div class="form-group col-sm-12" >
				  			<label class="col-sm-4 col-lg-2 control-label" for="id_pend">KTA / Nama Anggota </label>
								<div class="col-sm-7">
									<select class="form-control select2 input-sm" id="id_pend" name="id_pend"  onchange="formAction('main')" style="width:100%" >
										...
										<?php foreach ($penduduk as $data): ?>
											<option value="<?= $data['id']?>" <?php if ($individu['id']==$data['id']): ?>selected<?php endif; ?>>KTA : <?= $data['nik']." - ".$data['nama']." - ".$data['dusun']?></option>
										<?php endforeach;?>
									</select>
								</div>
							</div>
					...
					<div class="box box-primary">
						<div class="box-body">
							<div class="form-group">
								<label class="col-sm-4 control-label" for="pamong_nama">Nama Pengurus <?= ucwords($this->setting->sebutan_kabupaten)?></label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label" for="pamong_nik">Nomor KTA</label>
								<div class="col-sm-7">
