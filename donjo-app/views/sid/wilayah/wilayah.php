...
<div class="content-wrapper">
	<section class="content-header">
		<h1>Daftar <?= ucwords($this->setting->sebutan_kecamatan)?></h1>
		<ol class="breadcrumb">
			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<a href="<?= site_url('sid_core/form')?>" class="btn btn-social btn-flat btn-success btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Tambah Data"><i class="fa fa-plus"></i> Tambah Ranting</a>
													...
													<table class="table table-bordered table-striped dataTable table-hover">
														<thead class="bg-gray disabled color-palette">
															<tr>
																...
																<th>No</th>
																<th>Aksi</th>
																<th width="25%"> <?= ucwords($this->setting->sebutan_kecamatan)?></th>
																<th width="35%">Ketua <?= ucwords($this->setting->sebutan_kecamatan)?></th>
																<th>RW</th>
																<th>RT</th>
																<th>KK</th>
																<th>L+P</th>
